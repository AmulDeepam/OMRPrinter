...
var self=this;
    ...
    $.ajax({
       ...
       url: "http://52.66.243.218:8080/ERPDetails/ExpenseReport/DailyExpenseReport",
     ...
     var no;
   if(data.length!=0){
      var tab = '<thead><tr class="headcolor"><th>S.No</th><th>CategoryName</th><th>UserName</th><th>Amount</th><th>Date</th><th colspan="3" id="actions" style="text-align: center; ">Actions</th></tr></thead>';
      $.each(data, function (i, item) {
        ...
        +'<td><button id="edit">Edit</button></td></tr></tbody>';
  ...
  // $(w.document.body).html(html);
    ...
    render() {
        ...
        <div class="row">
                ...
                <h4 style={{fontWeight:"300",fontSize:"30px",textAlign:"center"}}>EXPENSE DAILY REPORT</h4>
                <hr></hr>
</div>
