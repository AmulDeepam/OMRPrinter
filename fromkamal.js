 ...
 */
 ...
 <Route path="/" component={Newpayslip} />
 ...
 <a class="dashboardanchorcolor" style={{padding:"5px 10px "}} onClick={() => this.PayRollFunc()}><i class="fa fa-money" style={{fontSize:"26px",paddingRight:" 24px", border: "none"}}></i>Payroll</a>
                            ...
                            <li>
 <a class="dashboardanchorcolor" style={{padding:"5px 10px "}} onClick={() => this.DeviceMapFunc()}><i class="fa fa-tablet" style={{fontSize:"26px",paddingRight:" 35px", border: "none"}}></i>Device</a>
 </li>
                            <li>
 <a class="dashboardanchorcolor" style={{padding:"5px 10px "}} onClick={() => this.PracticeFunc()}><i class="fa fa-tablet" style={{fontSize:"26px",paddingRight:" 35px", border: "none"}}></i>Practice</a>
 </li>
