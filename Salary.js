...
/* 
 ...
 url: "http://52.66.243.218:8080/ERPDetails/staff/selectstaff",
 ...
 url: "http://52.66.243.218:8080/ERPDetails/Payroll/StaffDetails",
 contentType: "application/json",
 dataType: 'json',
 async: false,
 success: function (data, textStatus, jqXHR) { 
...
if(this.state.totalWorkingHrs!=''){
 ...
 url: "http://52.66.243.218:8080/ERPDetails/Payroll/addsalary",
 contentType: "application/json",
 dataType: 'json',
 async: false,
 success: function (data, textStatus, jqXHR) {
...
self.setState({
 ...
 <div class="card-header">
         <h3 style={{fontWeight:"300",color:"black"}}>Salary Form</h3>
         <hr></hr>   </div>           
 <div>
 <div class="card-body">
 ...
 <div class="col-sm-10">
 <select id="staffName" className="form-control" onChange={this.handleStaffDetails} name="staffId" value={this.state.staffId} style={{ marginBottom: "15px" }}>
 
 </select> 
 </div>
 </div> 
 <div class="form-group">
 <label class="control-label col-sm-2" for="salaryMonth">Salary Month<span style={{ color: "red" }}>*</span></label>
 <div class="col-sm-10"> 
 ...
 <div class="form-group">
 <label class="control-label col-sm-2" for="salaryMonth">No.Of.Days/Month<span style={{ color: "red" }}>*</span></label>
 <div class="col-sm-10">
 ...
 <div class="form-group">
 <label class="control-label col-sm-2" for="salaryMonth">No.Of.Days Present<span style={{ color: "red" }}>*</span></label>
 <div class="col-sm-10">
 ...
 <div class="form-group">
 <label class="control-label col-sm-2" for="salaryMonth">No.Of.Days Leave<span style={{ color: "red" }}>*</span></label>
 <div class="col-sm-10">
 ...
 <div class="form-group">
 <label class="control-label col-sm-2" for="salaryMonth">No.Of.Days Absent<span style={{ color: "red" }}>*</span></label>
 <div class="col-sm-10">
 ...
 <div class="form-group">
 <label class="control-label col-sm-2" for="salaryMonth">No.Of.Days Holiday<span style={{ color: "red" }}>*</span></label>
 <div class="col-sm-10">
 ...
 <div class="form-group">
 <label class="control-label col-sm-2" for="salaryMonth">Company General Working Hours/Day<span style={{ color: "red" }}>*</span></label>
 <div class="col-sm-10">
 ...
 <div class="form-group">
 <label class="control-label col-sm-2" for="salaryMonth">Total No Of Working Hours<span style={{ color: "red" }}>*</span></label>
 <div class="col-sm-10">
 ...
 <div class="form-group">
 <label class="control-label col-sm-2" for="salaryMonth">Company Salary <span style={{ color: "red" }}>*</span></label>
 <div class="col-sm-10">
 ...
 <div class="form-group">
 <label class="control-label col-sm-2" for="salaryMonth">Company Per Salary<span style={{ color: "red" }}>*</span></label>
 <div class="col-sm-10">
 ...
 <div class="form-group">
 <label class="control-label col-sm-2" for="salaryMonth">General Working Hours<span style={{ color: "red" }}>*</span></label>
 <div class="col-sm-10">
 <input readOnly type="text" name="workingHrs" className="form-control" value={this.state.workingHrs}/>
  ...
  <div class="form-group">
 <label class="control-label col-sm-2" for="salaryMonth">OT Working Hours<span style={{ color: "red" }}>*</span></label>
 <div class="col-sm-10">
 ...
 <div class="form-group">
 <label class="control-label col-sm-2" for="salaryMonth">Company Salary For OT Working Hrs<span style={{ color: "red" }}>*</span></label>
 <div class="col-sm-10">
 ...
 <div class="form-group" id="empsalary">
 <label class="control-label col-sm-2" for="salaryMonth">Employee Salary<span style={{ color: "red" }}>*</span></label>
 <div class="col-sm-10">
 ...
 <button type="button" style={{fontWeight:"bold"}} onClick={() => this.AddSalaryFunc()} class="btn btn-primary">Submit</button> <span></span>
