	 ...
	 */
		 ...
		 public Response selectcustomer(SaleOrderJSON json) throws ParseException {
			 ...
			 */
				 ...
				 public Response selectindividualsaleproduct(SaleOrderJSON json) throws ParseException {
				    	System.out.println("going to select customer.......");
				    	SaleOrderController mas=new SaleOrderController();
					 ...
					 */
						 ...
						 public Response addsaleorder(SaleOrderJSON json) throws ParseException {
						    	System.out.println("going to add saleorder.......");
						    	SaleOrderController mas=new SaleOrderController();
						    	mas.addsaleorder(json);		
						    	System.out.println(json);
						    //	mas.selectinvoiceNo(json);	
							 ...
							 */
								 ...
								 public Response selectinvoiceNo(SaleOrderJSON json) throws ParseException {
								    	System.out.println("going to select sale report.......");
								    	SaleOrderController mas=new SaleOrderController();
												 ...
												 public Response addestimateorder(SaleOrderJSON json) throws ParseException {
													   ...
													   if(to!="null" || to!=" ") {
														  String body="	\n" + 
														  		...
														  		" Your invoice"+ json.getInvoiceNo()+" has been created"+"\n"+
														  		 "\n \n"  +
														  		"Your Invoice Amount is" + json.getBalance_amount()+ 
														  		"\n \n" + 
														  		"\n \n" + 
														  		"Thank you,\n\n" + 
														  		" OMR ART PRINTERS\n" + 
													 ...
													 */
														 ...
														 public Response estimateinvoicereport(SaleOrderJSON json) throws ParseException {
														    	System.out.println("going to retrive estimate report.......");
														    	SaleOrderController mas=new SaleOrderController();
