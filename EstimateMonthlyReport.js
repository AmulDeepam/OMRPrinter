...
var self=this;
    ...
    $.ajax({
       ...
       url: "http://52.66.243.218:8080/ERPDetails/EstimateReport/MonthlyEstimateReport",
...
printdiv(printarea) {
  ...
  <div class="row">
                ...
                <h5 style={{fontWeight:"300",fontSize:"30px",textAlign:"center"}}>ESTIMATE MONTHLY REPORT</h5>
...
<ReactHTMLTableToExcel
                    ...
                    sheet="tablexls"
                    buttonText="Download MonthlyEstimate List"/>
                    </div>
