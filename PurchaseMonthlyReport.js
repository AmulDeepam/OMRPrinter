...
var self=this;
    ...
    $.ajax({
       ...
       url: "http://52.66.243.218:8080/ERPDetails/PurchaseReport/MonthlyPurchaseReport",
        ...
        success: function (data, textStatus, jqXHR) {
            var no;
   if(data.length!=0){
      var tab = '<thead><tr class="headcolor"><th>S.No</th><th>Invoice</th><th>Date</th><th>Name</th><th>Contact</th><th>Status</th><th>Balance</th><th>Total</th></tr></thead>';
...
self.DeleteFunc(currentRow);
  ...
  $("#tableHeadings").on('click', '#view', function () {
	...
	ReactDOM.render(<PurchaseReportDisplay id={self.state.id}
...
<div class="row">
                ...
                <h5 style={{fontWeight:"300",fontSize:"30px",textAlign:"center"}}>PURCHASE MONTHLY REPORT</h5>
                <hr></hr>
</div>
...
<div class="col-sm-4 ">       
    ...
    <div class="tile-header">
              ...
              <h2>₹ <span id="igst">0</span></h2>
              
            </div>
           
            <div class="tile-footer"  style={{backgroundColor:"rgb(4, 3, 70)"}}>
              <h3 class="pull-right">Total Expenses</h3>
            </div>
    </div>
    </div>
*/} 
...
<ReactHTMLTableToExcel
                    ...
                    sheet="tablexls"
                    buttonText="Download PurchaseMonthly List"/>
                    </div>
