	...
	//	,,,,,,,,,,,"
		...
		try {
			...
			//	salesData.setAddress(rs.getString("address"));
				...
				salesData.setSize(rs.getString("size"));
				salesData.setUnit(rs.getString("unit"));
				...
				salesData.setHeight(rs.getString("height"));
				salesData.setWidth(rs.getString("width"));
		...
		try {
			...
			while (rs2.next()) {
				...
				System.out.println("sum of month saleinvoice data value...." + "SaleInvoice_Total_Amt" + "value saleinvoice"
						+ rs2.getString("SaleInvoice_Total_Amt"));
