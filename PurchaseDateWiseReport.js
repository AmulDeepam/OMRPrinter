...
class PurchaseDateWiseReport extends Component {
    ...
    $.ajax({
       ...
       url: "http://52.66.243.218:8080/ERPDetails/PurchaseReport/DateWisePurchaseReport",
   ...
   <ul class="previous disabled" id="backbutton"
                    ...
                    <h2 style={{fontWeight:"300",fontSize:"30px",textAlign:"center"}}> {this.state.companyName}</h2>
                        ...
                        <h4 style={{ fontWeight: "300",fontSize:"30px" ,textAlign:"center"}}>PURCHASE DATEWISE REPORT</h4>
                    </div>  
